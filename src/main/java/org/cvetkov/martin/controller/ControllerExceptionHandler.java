...
public class ControllerExceptionHandler {
	...
	public ResponseEntity<ErrorMessage> statusNotValid(org.springframework.http.converter.HttpMessageNotReadableException e) {
		String errorMessage;
		Throwable cause = e.getCause();
		if (cause instanceof JsonMappingException && cause.getCause() instanceof DeviceStatusNotValidException) {
			errorMessage = "Status of a device is not valid.";
		}else {
