...
import org.cvetkov.martin.utilities.GatewayResponse;
...
public class GatewaysController {
	...
	@ResponseStatus(HttpStatus.OK)
	public GatewayResponse updateGateway(@PathVariable("serialNumber") String serialNumber, @RequestBody GatewayUpdate gatewayUpdate) {

		service.updateGateway(serialNumber, gatewayUpdate);
		return new GatewayResponse("Gateway with serial number " + serialNumber + " was updated.");
	}
